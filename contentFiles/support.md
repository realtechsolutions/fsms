...
implementation, maintenance, update and continual improvement of the FSMS.
...
d) other organizations that have an impact on, or will be affected by, the effectiveness or updating of
the FSMS.
...
The food safety team shall ensure that this information is included when updating the FSMS (see 4.4
and 10.3).
...
alterations.
NOTE
Access can imply a decision regarding the permission to view