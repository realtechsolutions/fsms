...
3. ##### Organizational roles, responsibilities and authorities
   ...
   b. appointing the food safety team and the food safety team leader;

   c. reporting on the performance of the FSMS to top management;

   d. designating persons with defined responsibility and authority to initiate and document action(s);

   e. ensuring the FSMS is established, implemented, maintained and updated;

   f. ensuring relevant training and competencies for the food safety team;

   g. managing and organizing the work of the food safety team;

   h. reporting to top management on the effectiveness and suitability of the FSMS.

   All persons shall have the responsibility to report problems with regards to the FSMS to designated persons.